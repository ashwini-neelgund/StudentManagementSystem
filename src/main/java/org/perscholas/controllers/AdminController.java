...
public class AdminController {
  ...
  /**
   * Adds all available courses from the database to the model and returns the path to
   * all-courses.html.
   *
   * @param model
  ...
  /**
   * Post mapping for student-info.html. Looks up the student by the provided email address, adds
   * that student to the model, and returns the path back to student-info.html.
   *
