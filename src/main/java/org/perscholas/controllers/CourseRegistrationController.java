...
public class CourseRegistrationController {
  ...
  /**
   * This adds the student, a list of the students courses, and a filtered list of all of the
   * courses that the students has not yet enrolled in.
   *
   * @param model
   */
  @ModelAttribute
  ...
  /**
   * This filters out courses from a course list that an arbitrary student already has in their
   * course list.
   *
